                                ...
                                <div class="container">
                                        ...
                                        <div class="scrollbox">
                                                <table class="resultTable" id="resultTable">
                                                        <% List<TableRow> tableData = history.getHistory();
                                                                for (TableRow row: tableData) { %>
                                                                <tr>
                                                                    <td><%=row.getX()%></td>
                                                                    <td><%=row.getY()%></td>
                                                                    <td><%=row.getR()%></td>
                                                                    <td><%=row.getResultData()%></td>
                                                        ...
                                                        <td>
                                                                <div class="graph-container">
                                                                        <svg width="300" height="300" id="svg">
                                                                                ...
                                                                                <path style=" stroke:rgb(242, 206, 176);opacity: 0.8; fill: rgb(255, 226, 187)" d="M150,150 L50,150 A90,90 0 0,1 150,50 Z"></path>
